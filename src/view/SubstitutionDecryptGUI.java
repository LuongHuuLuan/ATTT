...
public class SubstitutionDecryptGUI extends JPanel {
	/**
	 * 
	 */
	...
	public void onDecrypt() {
		if (textAreaCipherText.getText().trim().length() == 0) {
			...
			if (key.length() != substitution.getAlphabetLength()) {
				...
				String decryptText = substitution.decrypt(this.textAreaCipherText.getText(), key);
